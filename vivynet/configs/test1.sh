...
# VIVY_LATENT_HIDDEN_DIM=1024
# VIVY_LATENT_OUTPUT_DIM=512
# VIVY_LATENT_HIDDEN_LAYERS=1
# VIVY_LATENT_DROPOUT_RATE=0.25
VIVY_LATENT=transformer_encoder
VIVY_LATENT_NUM_LAYERS=12
VIVY_LATENT_NUM_ATTN_HEADS=16
VIVY_LATENT_EMBED_DIM=128
VIVY_LATENT_DROPOUT=0.3
VIVY_LATENT_INPUT_DIM=768
VIVY_LATENT_OUTPUT_DIM=512
VIVY_LATENT_SELF_ATTENTION_TYPE=causal-linear
