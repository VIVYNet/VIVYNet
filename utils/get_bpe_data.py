...
if __name__ == '__main__':
    ...
    raw_data_path = '/home/blherre4/VIVY/VIVYNet/decoder/symphony_net/data/preprocessed/raw_corpus.txt'
    merged_data_path = '/home/blherre4/VIVY/VIVYNet/decoder/symphony_net/data/preprocessed/raw_corpus_bpe.txt'
    output_dir = '/home/blherre4/VIVY/VIVYNet/decoder/symphony_net/data/bpe_res/'
    ...
    with open(output_dir+'codes.txt', 'w') as stdout:
        with open(output_dir+'merged_voc_list.txt', 'w') as stderr:
            subprocess.run(['pwd'])
            subprocess.run(['/home/blherre4/VIVY/VIVYNet/decoder/symphony_net/music_bpe_exec', 'learnbpe', f'{MERGE_CNT}', output_dir+'ori_voc_cnt.txt'], stdout=stdout, stderr=stderr)
