...
#SBATCH --output=results/run4/slurm/out_%j.txt                                                        ## job /dev/stdout record
#SBATCH --error=results/run4/slurm/err_%j.txt                                                         ## job /dev/stderr record
...
#SBATCH --job-name="VIVYNet Training - run1"                                                          ## optional job name
